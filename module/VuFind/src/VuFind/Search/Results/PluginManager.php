...
class PluginManager extends \VuFind\ServiceManager\AbstractPluginManager
{
    ...
    protected $aliases = [
        ...
        'search3' => \VuFind\Search\Search3\Results::class,
        'search3collection' => \VuFind\Search\Search3Collection\Results::class,
    ...
    protected $factories = [
        ...
        \VuFind\Search\Search3\Results::class =>
            \VuFind\Search\Search3\ResultsFactory::class,
        \VuFind\Search\Search2Collection\Results::class => ResultsFactory::class,
        \VuFind\Search\Search3Collection\Results::class => ResultsFactory::class,
