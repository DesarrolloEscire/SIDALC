...
class PluginManager extends \VuFind\ServiceManager\AbstractPluginManager
{
    ...
    protected $aliases = [
        ...
        'search3' => \VuFind\Search\Search3\Options::class,
        'search3collection' => \VuFind\Search\Search3\Options::class,
    ...
    protected $factories = [
        ...
        \VuFind\Search\Search3\Options::class => OptionsFactory::class,
        \VuFind\Search\Search3Collection\Options::class => OptionsFactory::class,
