 ...
 */
class Search3ApiController extends SearchApiController
{
    /**
     ...
     * @var string
     */
    protected $searchClassId = 'Search3';
     ...
     * @var string
     */
    protected $recordRoute = 'index3/record';
     ...
     * @var string
     */
    protected $searchRoute = 'index3/search';
